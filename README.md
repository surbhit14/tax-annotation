...
| [`examples/f1040/`](examples/f1040/) | A worked annotation of Form 1040 (2025) exercising every field type, plus the official blank PDF it was measured against. |
...
npx ajv-cli validate --spec=draft2020 --strict=false -s schema/annotation.schema.json -d examples/f1040/f1040.annotation.json
